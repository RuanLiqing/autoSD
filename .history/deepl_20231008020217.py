...
def en__docx_translator(input_path, output_path, target_language, auth_key):
    extract_sentences_array = extract_sentences_from_docx(input_path)
...
# 提取 英文 文件中的句子，返回数组
def extract_sentences_from_docx_(file_path):
