...
def translate_sentences_with_deepl(sentences, api_key, source_lang, target_lang):
    ...
    for sentence in sentences:
       ...
       try:
            ...
            print(f"Error processing translation for sentence '{sentence}': {e}")
            continue
...
# 使用示例：
api_key = "916ea6b7-7638-e520-0440-a4c49a4873af:fx"  # 替换为你的DeepL API密钥
chinese_sentences = ["你好", "我爱编程", "这是一个测试"]
english_sentences = translate_sentences_with_deepl(chinese_sentences, api_key, "ZH", "EN")
