    ...
    for file in files:
        if file.endswith(".docx"):
            ...
            try:
                ...
                # 保存新文件
                new_file_path = os.path.join(en_sentences"/Users/ruanliqing/Library/Mobile Documents/com~apple~CloudDocs/startup/推文/400句话英文", file.replace(".docx", f"{howmany}.docx"))
