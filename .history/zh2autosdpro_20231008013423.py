    ...
    for file in files:
        if file.endswith(".docx"):
            ...
            try:
                ...
                print('翻译完成：', selected_sentences_translated[:20] if selected_sentences_translated.len)
                ...
                # 保存新文件
                new_file_path = os.path.join("/Users/ruanliqing/Library/Mobile Documents/com~apple~CloudDocs/startup/推文/400句话英文", file.replace(".docx", f"{howmany}.docx"))
