...
def zh_docx_translator(file_path, target_language, auth_key):
    extract_sentences_array = extract_sentences_from_docx_zh(file_path)
    translated_array = array_translator(extract_sentences_array, target_language, au)
